    ...
    return (
        <section className="elements">
              <article className="element">
                <button className={cardDeleteButtonClassName} type="button" onClick={handleCardDeletePopup} ></button>
                <img src={props.card.link} className="element__photo" alt={props.card.name} onClick={handleClick}/>         
